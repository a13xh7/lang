...
Группа может быть закрытой либо открытой для всех.
Группа либо отображается в списке всех групп, либо пользовате приглашаются в группу по ссылке.

в группе есть доступная всем статистика каждого пользователя. 

Группа может быть 2 типов

- группа для обычных пользователей 

в этой группе у всех равные права. любой может задавать и отвечать на вопросы


- группа для школ.

в группе есть учитель и ученики.
все вопросы направляются учителю.
учитель решает разрешить ли ученикам отвечать на вопросв друг друга.
